...
INSERT INTO ads."order" (id, patient, doctor, medication, status, dosage) 
  VALUES 
    (2, 6, 1, 2, 1, '1 pill 2 times daily'),
    (3, 7, 2, 3, 1, '1 pill 2 times daily') , 
    (4, 8, 3, 10, 2, '1 pill as needed'), 
    (5, 7, 2, 15, 1, '1 pill daily'), 
    (6, 5, 1, 10, 1, '1 pill 2 times daily'), 
    (7, 8, 3, 13, 2, '1 pill as needed'), 
    (8, 5, 1, 4, 2, 'need dosage'), 
    (9, 8, 3, 12, 1, 'need dosage'), 
    (10, 7, 2, 8, 2, 'need dosage'), 
    (11, 9, 4, 11, 1, 'need dosage'), 
    (12, 7, 2, 5, 1, 'need dosage'), 
    (13, 9, 4, 10, 2, 'need dosage'), 
    (14, 7, 2, 9, 2, 'need dosage'), 
    (15, 7, 2, 9, 1, 'need dosage'), 
    (16, 8, 3, 6, 1, 'need dosage'), 
    (17, 8, 3, 8, 1, 'need dosage'), 
    (18, 8, 3, 2, 1, 'need dosage'), 
    (19, 9, 4, 16, 1, 'need dosage'), 
    (20, 8, 3, 6, 1, 'need dosage'), 
    (21, 7, 2, 2, 1, 'need dosage'), 
    (22, 8, 3, 10, 1, 'need dosage'), 
    (23, 8, 3, 20, 1, 'need dosage'), 
    (24, 8, 3, 10, 2, 'need dosage'), 
    (25, 8, 3, 20, 2, 'need dosage'), 
    (26, 9, 4, 11, 2, 'need dosage'), 
    (27, 9, 4, 17, 2, 'need dosage'), 
    (28, 9, 4, 12, 2, 'need dosage'), 
    (29, 8, 3, 17, 2, 'need dosage'), 
    (30, 9, 4, 3, 2, 'need dosage'), 
    (31, 9, 4, 21, 1, 'need dosage');
